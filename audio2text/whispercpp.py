...
class CppTranscriber:
    ...
    def transcribe(self, in_path, out_path):
        ...
        tmp_file = self.__convert(in_path)
        self.__transcribe_processed_wav(tmp_file, out_path)
    ...
    def __transcribe_processed_wav(self, in_path, out_path = False):
        cmd = [
